...
import 'package:instagram_clone/features/instagram_clone/presentation/notifiers/posts/providers/all_posts_provider.dart';
...
class AllPostsView extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return RefreshIndicator(
      onRefresh: () {
        posts = ref.refresh(allPostsProvider);
        ...
        posts.fold((failure) {
          ...
          if (posts.isEmpty) {
            returnedWidget = const EmptyContentWithTextAnimation(
              text: Constants.noPostsAvailable,
            );
          } else {
